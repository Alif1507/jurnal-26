            ...
            <form action="{{ route('post.store') }}" method="post" enctype="multipart/form-data" class="mx-auto max-w-sm">
                ...
                <div class="mb-5">
                    ...
                    <input type="file" id="image" name="image" accept="image/*"
                        class="block w-full cursor-pointer rounded-lg border border-gray-300 bg-gray-50 text-sm text-gray-900 focus:outline-none :border-gray-600 :bg-gray-700 :text-gray-400 :placeholder-gray-400">
                </div>
