<div class="mt-24 max-md:mt-64">
  <div data-aos="fade-up" class="flex flex-col items-center gap-2">
    <h1 class="font-inter font-bold text-4xl max-md:text-center max-md:text-2xl text-white">Selamat Datang Di Jurnalistik 26</h1>
    <div class="bg-[#F09B0E] w-[494px] max-md:w-[200px] h-1">.</div>
    <h1 class="font-inter text-xl max-md:text-lg text-white opacity-30">Welcome To 26 Journalism</h1>
  </div>
