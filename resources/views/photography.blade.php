...
<body class="bg-[#011423]">
    <x-navbar></x-navbar>
    <a href="{{ route("welcome.index") }}" class="fixed hover:bg-white hover:text-[#F09B0E] text-stone-50 transition-all duration-100 hover:scale-110 bg-[#F09B0E] z-40 p-2 rounded-full flex items-center justify-center">
